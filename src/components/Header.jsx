       ...
       <header>
          ...
          <Fade right cascade> 
              <div className="icons">
                 ...
                 <a className="social-links"  href="https://docs.google.com/document/d/1xjv0WyEcZ6oFewF-id0XUxm5XHYI4NWVCZ3gLhfu-nQ/edit?usp=sharing" target="_blank"> <FaGoogleDrive/></a>
